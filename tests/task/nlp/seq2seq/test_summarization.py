...
from lightning_transformers.task.nlp.seq2seq.summarization import SummarizationDataModule, SummarizationTransformer
from lightning_transformers.task.nlp.seq2seq.summarization.config import SummarizationConfig


@pytest.mark.skipif(sys.platform == "win32", reason="Currently Windows is not supported")
def test_smoke_train_e2e(script_runner):
    script_runner.hf_train(task="seq2seq/summarization", dataset="xsum", model="patrickvonplaten/t5-tiny-random")
