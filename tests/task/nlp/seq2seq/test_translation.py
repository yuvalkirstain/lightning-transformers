...
from lightning_transformers.task.nlp.seq2seq.translation import TranslationTransformer, WMT16TranslationDataModule
from lightning_transformers.task.nlp.seq2seq.translation.config import TranslationConfig, TranslationDataConfig
from lightning_transformers.task.nlp.seq2seq.translation.data import TranslationDataModule
...
def test_smoke_train_e2e(script_runner):
    script_runner.hf_train(task="seq2seq/translation", dataset="wmt16", model="patrickvonplaten/t5-tiny-random")
